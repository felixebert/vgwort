 ...
 * generated in the de.schreibfabrik.vgwort.soap.message package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.schreibfabrik.vgwort.soap.message
     * 
     */
