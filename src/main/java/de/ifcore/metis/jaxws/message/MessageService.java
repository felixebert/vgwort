 ...
 * 
 */
@WebServiceClient(name = "MessageService", targetNamespace = "http://vgwort.de/1.2/MessageService", wsdlLocation = "https://tom-test.vgwort.de/services/1.2/messageService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName MESSAGESERVICE_QNAME = new QName("http://vgwort.de/1.2/MessageService", "MessageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://tom-test.vgwort.de/services/1.2/messageService.wsdl");
    ...
    public Message getMessagePort() {
        return super.getPort(new QName("http://vgwort.de/1.2/MessageService", "MessagePort"), Message.class);
    }
    ...
    public Message getMessagePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://vgwort.de/1.2/MessageService", "MessagePort"), Message.class, features);
    }
