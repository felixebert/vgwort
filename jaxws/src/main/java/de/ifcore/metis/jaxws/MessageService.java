 ...
 * 
 */
@WebServiceClient(name = "MessageService", targetNamespace = "http://vgwort.de/1.3/MessageService", wsdlLocation = "https://tom.vgwort.de/services/1.3/messageService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName MESSAGESERVICE_QNAME = new QName("http://vgwort.de/1.3/MessageService", "MessageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://tom.vgwort.de/services/1.3/messageService.wsdl");
    ...
    public Message getMessagePort() {
        return super.getPort(new QName("http://vgwort.de/1.3/MessageService", "MessagePort"), Message.class);
    }
    ...
    public Message getMessagePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://vgwort.de/1.3/MessageService", "MessagePort"), Message.class, features);
    }
